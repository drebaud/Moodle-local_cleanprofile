<?php
// This file is part of cleanprofile module Moodle - http://moodle.org/
//
...
$string['settings:case_lower'] = 'bas de casse';
$string['settings:case_upper'] = 'HAUT DE CASSE';
$string['settings:case_title'] = 'Majuscule À Chaque Mot';
$string['settings:firstname_accent'] = 'Ajouter les accents au prénom';
$string['settings:firstname_accent_helpset'] = 'Corriger les accents manquants dans le prénom (ex. Eric -> Éric)';
